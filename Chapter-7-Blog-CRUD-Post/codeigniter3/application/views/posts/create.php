		  ...
		  <div class="card mb-4">
			...
			<?php echo form_open_multipart('post/create'); ?>
				<div class="form-group">
					...
					<input type="file" name="userfile" class="form-control" placeholder="Select File">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<textarea rows="4" name="summary" class="form-control" placeholder="Enter Short Description"></textarea>
				</div>
				<div class="form-group">
					<label for="exampleFormControlTextarea1">Description</label>
					<textarea name="description" class="form-control" rows="6" placeholder="Enter Short Description"></textarea>
				</div>
