		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item">
						<a class="nav-link" href="<?php echo base_url()."index.php/blog/post"?>">New Post</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="#">New Categorey</a>
					</li>
					<li class="nav-item">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8">
				...
				<div class="card mb-4">
					<img class="card-img-top" src="<?php echo base_url() . 'assets/images/' . $post->image ?>" alt="Card image cap">
					<div class="card-body">
						<h2 class="card-title"><?php echo $post->title; ?></h2>
						<p class="card-text"><?php echo $post->summary; ?></p>
						<a href="<?php echo base_url()."index.php/blog/detail"?>" class="btn btn-primary">Read More &rarr;</a>
					</div>
					<div class="card-footer text-muted">
						Posted on <?php echo date("F Y, d", strtotime($post->created)); ?> by
